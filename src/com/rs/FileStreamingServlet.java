...
public class FileStreamingServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        this.basePath = Resource.CONTENT_HOME_LOCATOR.getContentHome().getAbsolutePath();
        //Station.STATIONS_HOME_DIR.getAbsolutePath(); // getInitParameter("basePath");
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //response.getWriter().println("<meta property=\"og:title\" content=\"" + req.getParameter("foo") + "\" />");

      /*  VideoRouter videoDispatcher = VideoRouter.create(request, response);

        if(videoDispatcher.shouldRoute()){
    ...
    (HttpServletRequest request, HttpServletResponse response, boolean content)
        ...
        /*if (request.getAttribute("download_video_request") != null) {
            LOG.fine("Start copy <video file " + file.getName() + " to client..." + file.getAbsolutePath());
